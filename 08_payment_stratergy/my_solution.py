...
class PaymentType(Protocol):
    def process_payment(self, total: Decimal):
        ...
...
class ShoppingCart:
    ...
    payment_type: PaymentType = field(default=None)
    ...
    def process_payment(self) -> None:
        self.payment_type.process_payment(self.total)
...
def main() -> None:
    ...
    payment_type = PAYMENT_NAME_TO_TYPE.get(payment_name)
    cart.set_payment_type(payment_type)
